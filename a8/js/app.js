...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Intentar bloquear la orientación a retrato (Solo funciona en PWA/Full Screen)
  if (screen.orientation && screen.orientation.lock) {
    screen.orientation.lock('portrait').catch(function (error) {
      console.log('Rotación no bloqueada (normal en navegador):', error);
      // Fallback: Forzar visualización correcta mediante CSS si es necesario
    });
  }
