...
function initUIListeners() {
    ...
    function initPDAModes() {
        ...
        function updateUserInfoAndClient() {
        ...
        function setMode(mode) {
            ...
            if (mode === 'PDA') {
                ...
                if (inputIcon) {
                    ...
                    inputIcon.title = "Tocar para alternar Foco Persistente";
                }
        ...
        function handleInputInteraction(e) {
            ...
            if (window.APP_MODE === 'PDA') {
                ...
                if (typeof USER_SETTINGS !== 'undefined') {
                    ...
                    setTimeout(() => {
                        if (window.APP_MODE === 'PDA') statusDiv.textContent = "Modo PDA: Escaneo rápido";
                    }, 2000);
...
function initSettingsUI() {
    ...
    // Load Settings to UI
    function loadToUI() {
        if (focusToggle) focusToggle.checked = USER_SETTINGS.persistentFocus;
