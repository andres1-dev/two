...
function cancelSelectedTransfers() {
    ...
    showMessage(`${transfersToCancel.length} traslados anulados correctamente. Usa "Reprocesar" para aplicar los cambios.`, 'success', 3000);
    
    // Actualizar la interfaz
    updateCancelledTransfersTable();
    document.getElementById('reprocessBtn').style.display = 'inline-block';
